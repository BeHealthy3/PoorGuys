...
import LoremSwiftum
    ...
    struct Comment: Identifiable, Codable, Equatable {
        ...
        static func dummy() -> Comment {
            ...
            return Comment(id: id, nickName: nickName, profileImageURL: profileImageURL, userID: userID, postID: postID, content: content, likeCount: likeCount, likedUserIDs: likedUserIDs, timeStamp: timeStamp, isDeletedComment: likeCount.isMultiple(of: 7) ? true : false, belongingCommentID: likeCount.isMultiple(of: 2) ? nil : "\(2)")
        }
